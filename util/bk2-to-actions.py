...
from baselines.common.atari_wrappers import WrapFrame, FrameStack


stage_string = ''  # TODO: String describing the movie's stage
movie_path = ''  # TODO: Path to the movie file (.bk2)
movie = retro.Movie(movie_path)
movie.step()

scenario_string = 'test_retro'  # TODO: 'test_retro' | 'trajectory_max'; not sure what this exactly means yet
...
env.initial_state = movie.get_state()  # Looks like get_state() is a generator yielding next state?
...
NOOP_constant = 6  # TODO: Not sure what this is but seems like it's one of the possible actions?
...
game_dict = define_action_dict(key_dict)
num_steps = 0
total_reward = 0.
